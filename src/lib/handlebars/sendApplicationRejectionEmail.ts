...
import { applicationRejectionTemplate } from "../../templates/ApplicationRejection";
import { transporter } from "../nodemailer";

const sendApplicationRejectionEmail = async (data: {
  email: string;
  position: string;
  company_name: string;
  ...
  const template = handlebars.compile(applicationRejectionTemplate);
...
export default sendApplicationRejectionEmail;
