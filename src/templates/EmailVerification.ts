...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <h1>Welcome to SupaJob!</h1>
      <p class="welcome-text">Hello <span class="highlight">{{name}}</span>,</p>
      <p>We're excited to have you join our community. To get started, please verify your email address.</p>
      <div class="button-container">
        <a href="{{verificationLink}}" target="_blank" class="button">Verify Email Address</a>
      </div>
      <p class="expiry-notice">This verification link will expire in an hour.</p>
